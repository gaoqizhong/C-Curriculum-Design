...
void users::buy_1()				//地铁购票>>线路选择
{
	...
	cout<<" 地铁购票>>线路选择"<<endl<<endl<<endl
		...
		<<"             line1     尚双塘    开福区政府      3        6      06:30-23:00"<<endl
		<<"             line2      光达      梅溪湖西       3        6      06:30-23:00"<<endl
		<<"             line4     罐子岭      杜家坪        3        6      06:30-23:00"<<endl
...
void lines::line_information_1()//地铁查询>>查询线路站点 
{
	...
	cout<<" 地铁查询>>选择服务>>线路站点"<<endl<<endl<<endl
		...
		<<"             line1    开福区政府   培元桥    五一广场    黄土岭     尚双塘"<<endl
		<<"             line2     梅西湖西    橘子洲    五一广场   火车南站     光达"<<endl
		<<"             line4      罐子岭     溁湾镇    湖南大学    阜埠河     杜家坪"<<endl
		<<"             maglev         磁浮高铁站      磁浮槊梨站      磁浮机场站"<<endl 
		<<"           *****************************************************************"<<endl<<endl
		<<"               ☆更多资讯请访问https://baike.baidu.com/item/长沙轨道交通"<<endl<<endl
		<<"                                                                  E.返回首页"<<endl
		<<"                                             ";
	getchar();getchar();
} 
...
void users::destroy() 			//账户管理>>销毁账户 
{
	...
	cout<<" 账户管理>>选择服务>>销毁账户"<<endl<<endl<<endl
		...
		<<"         ****************************************"<<endl
		<<"                  长沙地铁通用户销户协议"<<endl<<endl
		<<"            尊敬的 "<<name<<" :"<<endl
		<<"                感谢您长期以来对长沙地铁通的支"<<endl
